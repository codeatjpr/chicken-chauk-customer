...
import { ProductGridSkeleton } from "@/components/organisms/product-grid";
...
export function SearchPage() {
  ...
  return (
    <div className="space-y-5 pb-4">
      <h1 className="text-xl font-semibold tracking-tight sm:text-2xl">Discover items in your area.</h1>
      ...
      {!enabled ? (
        ...
        <div className="space-y-4">
          ...
          <ProductGridSkeleton count={8} className="grid-cols-2 lg:grid-cols-4" />
        </div>
      ) : searchQuery.isError ? (
            ...
            <section>
              <div className="mb-3 flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Shops matching your search right now.</p>
                </div>
            ...
            <section>
              <div className="mb-3 flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Tap any listing to view full details and add to cart.</p>
                </div>
