...
export function LoginPage() {
  ...
  const lockoutRemainingSec = isLocked
    ? Math.ceil((lockoutUntil! - clock) / 1000)
    : 0

  const resendRemainingSec =
    resendAt != null && clock < resendAt
      ? Math.ceil((resendAt - clock) / 1000)
      : 0
  ...
  return (
    <div className="from-accent/30 via-background to-background relative min-h-svh bg-gradient-to-br">
      <div className="absolute end-4 top-4 flex justify-end gap-2">
        <ThemeToggle />
      </div>
        ...
        <Card className="border-border/80 w-full max-w-md shadow-md">
          <CardHeader>
            ...
            <CardDescription>
              {step === 'phone'
                ...
                : `Code sent to ${maskPhoneForOtpStep(phone10)}`}
            </CardDescription>
          </CardHeader>
          ...
          {step === 'phone' ? (
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <span className="border-input bg-muted text-muted-foreground flex h-8 shrink-0 items-center rounded-lg border px-2.5 text-sm">
                      +91
                    </span>
                    <Input
                      id="phone"
            ...
            <>
              <CardContent className="space-y-4">
                ...
                {isLocked && (
                  ...
                  >
                    ...
                    {formatLockout(lockoutRemainingSec)}.
                  </div>
                )}
              ...
              <CardFooter className="flex-col gap-2 border-t-0 pt-0">
                <Link
                  to={ROUTES.root}
